...
<?php		submit_button( __( 'Save', 'vat_moss' ), 'primary', 'save_definition', false, array( 'style' => 'float: right; margin-top: 10px;' ) ); ?>
			<a href='?page=moss-saf-definitions' class='button secondary' style='float: right; margin-top: 10px; margin-right: 10px;'><?php _e('Definitions', 'vat_moss'); ?></a>
